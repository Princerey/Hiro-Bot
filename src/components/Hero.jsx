...
const Hero = () => {
  return (
    ...
    <header className='w-full flex justify-center items-center flex-col'>
      ...
      <div className='mt-1 sm:mt-8 flex flex-col justify-center items-center '>
      <h1 className='head_text' style={{fontFamily:"Yanone Kaffeesatz",fontWeight:"400",color:"#3d3d3d"}}>
        ...
        <div className='flex-col flex items-center justify-center w-full'><span className='orange_gradient ' style={{fontFamily:"poppins"}}>Powered By </span><img src={gemini} alt='gemini' className='w-[160px] sm:w-[200px] object-contain relative bottom-5 sm:bottom-7' style={{filter:"brightness(0.55)"}}></img></div>
      </h1>
